...
def evaluate_method(gtFilePath, submFilePath, evaluationParams):
    ...
    for resFile in gt:
        ...
        _,_,gtWordsLine = rrc_evaluation_funcs.get_tl_line_values_from_file_contents(gtFile,evaluationParams['CRLF'],False,True,False)
        ...
        precision = float(0) if detNumWords==0 else float(precisionAccum) / detNumWords

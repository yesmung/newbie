...
def benchmark_all_eval(model, criterion, converter, opt, calculate_infer_time=False):
    ...
    for eval_data in eval_data_list:
        ...
        evaluation_loader = torch.utils.data.DataLoader(eval_data,
    ...
    with open(f'./result/{opt.experiment_name}/log_all_evalutation.txt', 'a') as log:
...
def recog_loader(data_path):
    ...
    # load model
    print('loading pretrained model from %s' % opt.saved_model)
    model.load_state_dict(torch.load(data_path+'data/model.pth'))
    return model
...
def main():
    ...
    for folder_idx in range(4):
        ...
        datadb = create_database(folder_idx+1, "recog_train_task2_pad_split")
        num_images = 1
        db_start_idx = 0
        for idx in tqdm(range(len(img_files))):
            ...
            crop_img, crop_coords = get_crop_image_by_coords_pad(img_files[idx], coords_table[idx], num_images=num_images)
